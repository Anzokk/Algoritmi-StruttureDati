...
Comandi per eseguire il codice java: 
- java -cp classes graph.Prim src/graph/italian_dist_graph.csv
- java -cp classes:lib/junit-4.13.2.jar:lib/hamcrest-core-1.3.jar org.junit.runner.JUnitCore graph.Graph_test
- java -cp classes:lib/junit-4.13.2.jar:lib/hamcrest-core-1.3.jar org.junit.runner.JUnitCore priorityqueue.PriorityQueue_test
